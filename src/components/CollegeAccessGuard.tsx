...
export function CollegeAccessGuard({ children }: { children: React.ReactNode }) {
  const { canViewCollege, isLoading } = useUserPermissions();
        ...
        <Card className="border-destructive/30 bg-destructive/5 shadow-lg">
          <CardHeader className="text-center pb-3">
            ...
            <CardDescription className="text-sm text-muted-foreground mt-1">
              You do not have permission to access the Nursing College Module.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4 text-center">
            <p className="text-xs text-muted-foreground leading-relaxed">
              This module is restricted to authorized administrators, accounts personnel, and members of the <strong>ACON</strong> department.
            </p>
